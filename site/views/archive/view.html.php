 ...
 * @since  1.5
 */
class BfdownloadmanagerViewArchive extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		foreach ($items as $item)
		{
			...
			$results = $dispatcher->trigger('onBfdownloadmanagerAfterTitle', array('com_bfdownloadmanager.archive', &$item, &$item->params, 0));
			$item->event->afterDisplayTitle = trim(implode("\n", $results));

			$results = $dispatcher->trigger('onBfdownloadmanagerBeforeDisplay', array('com_bfdownloadmanager.archive', &$item, &$item->params, 0));
			$item->event->beforeDisplayBfdownloadmanager = trim(implode("\n", $results));

			$results = $dispatcher->trigger('onBfdownloadmanagerAfterDisplay', array('com_bfdownloadmanager.archive', &$item, &$item->params, 0));
		...
		// Month Field
		$months = array(
			'' => JText::_('COM_BFDOWNLOADMANAGER_MONTH'),
