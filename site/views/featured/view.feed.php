...
class BfdownloadmanagerViewFeatured extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		foreach ($rows as $row)
		{
			...
			$link = JRoute::_(BfdownloadmanagerHelperRoute::getDownloadRoute($row->slug, $row->catid, $row->language));
			...
			{
				$description .= '<p class="feed-readmore"><a target="_blank" href ="' . $item->link . '">' . JText::_('COM_BFDOWNLOADMANAGER_FEED_READMORE') . '</a></p>';
			}
