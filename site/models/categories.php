 ...
 * @since  1.6
 */
class BfdownloadmanagerModelCategories extends JModelList
{
	/**
	...
	public function getItems($recursive = false)
	{
		...
		if (!isset($this->cache[$store]))
		{
			...
			$options = array();
			$options['countItems'] = $params->get('show_cat_num_downloads_cat', 1) || !$params->get('show_empty_categories_cat', 0);
