...
/**
 * Bfdownloadmanager download class.
 *
 * @since  1.6.0
 */
class BfdownloadmanagerControllerDownload extends JControllerForm
{
	...
	protected function allowAdd($data = array())
	{
		...
		if ($categoryId)
		{
			...
			$allow = $user->authorise('core.create', 'com_bfdownloadmanager.category.' . $categoryId);
		}
	...
	public function cancel($key = 'a_id')
	{
		...
		if ($customCancelRedir)
		{
			...
			{
				// Redirect to the same download submission form (clean form).
	...
	public function vote()
	{
		...
		if ($user_rating > -1)
		{
			...
			{
				$this->setRedirect($url, JText::_('COM_BFDOWNLOADMANAGER_DOWNLOAD_VOTE_SUCCESS'));
			}
			else
			{
				$this->setRedirect($url, JText::_('COM_BFDOWNLOADMANAGER_DOWNLOAD_VOTE_FAILURE'));
			}
		}
	}
}
