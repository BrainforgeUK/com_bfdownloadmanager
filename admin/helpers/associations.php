...
/**
 * Bfdownloadmanager associations helper.
 *
 * @since  3.7.0
 */
class BfdownloadmanagerAssociationsHelper extends AssociationExtensionHelper
{
	/**
	 * The extension name
	 *
	...
	public function getItem($typeName, $id)
	{
		...
		{
			case 'download':
				$table = JTable::getInstance('Bfdownloadmanager');
				break;
