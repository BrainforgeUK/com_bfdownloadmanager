...
<div class="container-popup">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_bfdownloadmanager&view=downloads&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1&editor=' . $editor); ?>"
