...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_bfdownloadmanager&task=downloads.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_bfdownloadmanager&view=downloads'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			<table class="table table-striped" id="downloadList">
					...
					<tr>
						...
						<?php if ($assoc) : ?>
							...
							<th width="5%" class="nowrap hidden-phone">
								<?php echo JHtml::_('searchtools.sort', 'COM_BFDOWNLOADMANAGER_HEADING_ASSOCIATION', 'association', $listDirn, $listOrder); ?>
							</th>
						<?php endif; ?>
						<th width="10%" class="nowrap hidden-phone">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canEditOwn = $user->authorise('core.edit.own',   'com_bfdownloadmanager.download.' . $item->id) && $item->created_by == $userId;
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
						...
						<td class="has-context">
							<div class="pull-left break-word">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_bfdownloadmanager&task=download.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
						...
						<td class="hidden-phone">
							<?php if ($item->association) : ?>
								<?php echo JHtml::_('bfdownloadmanageradministrator.association', $item->id); ?>
							<?php endif; ?>
						</td>
						<?php endif; ?>
						<td class="small hidden-phone">
			...
			<?php if ($user->authorise('core.create', 'com_bfdownloadmanager')
				...
				<?php echo JHtml::_(
					...
					'collapseModal',
					array(
						'title'  => JText::_('COM_BFDOWNLOADMANAGER_BATCH_OPTIONS'),
