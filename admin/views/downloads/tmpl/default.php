...
<form action="<?php echo JRoute::_('index.php?option=com_bfdownloadmanager&view=downloads'); ?>" method="post"
                            ...
                            <td class="has-context">
                                <div class="pull-left break-word">
									...
									<?php if ($canEdit || $canEditOwn) : ?>
                                        <a class="hasTooltip"
                                           href="<?php echo JRoute::_('index.php?option=com_bfdownloadmanager&task=download.edit&id=' . $item->id); ?>"
