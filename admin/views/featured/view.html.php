...
/**
 * View class for a list of featured downloads.
 *
 * @since  1.6
 */
class BfdownloadmanagerViewFeatured extends JViewLegacy
{
	...
	{
		BfdownloadmanagerHelper::addSubmenu('featured');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_BFDOWNLOADMANAGER_FEATURED_TITLE'), 'star featured');
		...
		JToolbarHelper::help('JHELP_CONTENT_FEATURED_DOWNLOADS');
	}
